...
using UnityEngine;
    ...
    public class AeroplaneAudio : MonoBehaviour
    {
        ...
        private DroneMovement m_Plane;      // Reference to the aeroplane controller.
        ...
        private void Awake()
        {
            ...
            m_Plane = GetComponent<DroneMovement>();
        ...
        private void Update()
        {
            ...
            var enginePowerProportion = Mathf.InverseLerp(0, m_Plane.throttleForce, m_Plane.MaxThrottle);
            ...
            // Увеличьте тангаж двигателя на величину, пропорциональную скорости движения самолета.
            // (это увеличивает высоту тона при погружении!)
            ...
            m_EngineSoundSource.volume = Mathf.InverseLerp(0, m_Plane.MaxThrottle * m_AdvancedSetttings.engineMasterVolume,
                                                         m_Plane.throttleForce);

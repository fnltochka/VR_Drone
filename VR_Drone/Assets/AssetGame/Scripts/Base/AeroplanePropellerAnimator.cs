...
using UnityEngine;
    ...
    public class AeroplanePropellerAnimator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            m_PropellorModel.Rotate(0, m_MaxRpm*m_Plane.throttleForce * Time.deltaTime*k_RpmToDps, 0);
            ...
            if (m_Plane.throttleForce > m_ThrottleBlurStart)
            {
                var throttleBlurProportion = Mathf.InverseLerp(m_ThrottleBlurStart, m_ThrottleBlurEnd, m_Plane.throttleForce);
